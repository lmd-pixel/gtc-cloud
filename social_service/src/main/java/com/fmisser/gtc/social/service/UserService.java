...
public interface UserService {
    ...
    // 创建用户
    User create(String phone, int gender, String nick, String inviteCode, String version,String channelId,String ipAdress,String deviceId,String email) throws ApiException;
    ...
    String getNick(String nick) throws ApiException;
